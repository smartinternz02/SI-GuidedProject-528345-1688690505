...
<div class="container-fluid">
  <img src="resources/images/restaurantlogo.png" width="35" height="35" class="d-inline-block align-top" alt="">
  <a class="navbar-brand" href="/"><h2 class="text-color"><b>PAPAJI's</b></h2></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
            Welcome to Papaji's, your one-stop shop for all things delicious! We are a multicuisine restaurant that offers a wide variety of dishes from around the world. Whether you're in the mood for Indian, Chinese, Italian, American, or something else entirely, we have you covered.<br><br>

            Our food is made with fresh, high-quality ingredients and prepared with care by our experienced chefs. We also offer a variety of vegan, vegetarian, and gluten-free options to accommodate all dietary needs.<br><br>
            
            In addition to our delicious food, we also have a warm and inviting atmosphere. Our dining room is spacious and comfortable, and our staff is friendly and attentive. We also offer a full bar with a wide selection of drinks to choose from.
            
            Whether you're looking for a casual meal with friends or a special occasion dinner.<br><br>
          </b>
        </p>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 7847953767 / +91 7200248526<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">oyeepapaji@gmail.com
            </b>
        </p>
        </div>
      </div>
